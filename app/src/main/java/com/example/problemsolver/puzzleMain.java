...
public class puzzleMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView moveCount = (TextView) findViewById(R.id.puzzle_moves_count);
        moveCount.setText("0");
        ...
        Spinner benches = (Spinner) findViewById(R.id.puzzle_benchmarks);
        AStarSolver aStar = new AStarSolver(problem);
        TextView stats = (TextView) findViewById(R.id.puzzle_stats);
        ...
        for (int i = 0; i < problem.getMover().getMoveNames().size(); i++) { //for loop to add buttons dynamically
            ...
            move.setBackgroundColor(Color.parseColor("#FFFF537B"));
            move.setText(name);
            move.setTextColor(Color.parseColor("#FFFFD8E1"));
        ...
        resetButton.setOnClickListener(view -> {
            ...
            for (Button m : buttonList) {
                m.setEnabled(true);
                m.setTextColor(Color.parseColor("#FFFFD8E1"));
            }
